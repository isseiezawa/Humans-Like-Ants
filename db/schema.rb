...
ActiveRecord::Schema[7.0].define(version: 2023_03_05_141305) do
  ...
  create_table "avatar_tag_maps", charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "avatar_tags", charset: "utf8mb4", force: :cascade do |t|
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "information", charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "world_rooms", charset: "utf8mb4", force: :cascade do |t|
  ...
  add_foreign_key "world_rooms", "users"
end
